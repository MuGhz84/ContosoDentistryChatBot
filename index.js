...
const CustQuestLangConfiguration = {
    knowledgeBaseId: process.env.Languageprojectname,
    endpointKey: process.env.LanguageResourceKey,
    host: process.env.Languageserviceendpointhostname
};
...
const CLUConfiguration = {
    ...
    CLU_StringIndexType: process.env.CLU_StringIndexType,
    CLUPredicURL: process.env.CLUPredicURL,
    ConfidenceScoreThreshold: process.env.ConfidenceScoreThreshold
};
